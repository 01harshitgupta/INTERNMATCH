    ...
    return (
      <div className={cn("relative", className)} ref={containerRef}>
        ...
        <div>
          ...
          {isOpen && (
            <div
              className="absolute z-50 w-full mt-1 bg-white text-black border border-border rounded-md shadow-md max-h-60 overflow-auto"
              role="listbox"
              aria-labelledby={selectId}
            >
              {searchable && (
              ...
              {filteredOptions.length === 0 ? (
                ...
                filteredOptions.map((option) => (
                  ...
                  >
                    ...
                    {multiple && isSelected(option.value) && <Check className="h-4 w-4" aria-hidden="true" />}
                    {option.description && (
