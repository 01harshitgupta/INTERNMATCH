...
class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    // Optionally log or report error here
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-neutral-50">
          <main className="text-center p-8 max-w-md" role="alert" aria-live="assertive">
            ...
            <h1 className="text-2xl font-medium text-neutral-800 mb-1">
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded flex items-center gap-2 transition-colors duration-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
