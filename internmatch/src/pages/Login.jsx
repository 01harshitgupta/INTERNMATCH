...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
      {/* Government Header */}
      <header
        className="absolute top-0 left-0 right-0 bg-white border-b-2 border-blue-600 shadow-sm"
      ...
      <main
        className="bg-white rounded-lg shadow-lg border border-gray-200 p-8 w-full max-w-md mt-16"
        role="main"
        tabIndex={-1}
      >
        ...
        <footer className="mt-6 text-center">
          <p className="text-xs text-gray-500">This is an official Government of India portal</p>
        </footer>
      </main>
    </div>
  );
